...
namespace StarterGame.Commands
{
    ...
    public class CommandWords
    {
        ...
        private static readonly Command[] CommandArray = { new GoCommand(), new QuitCommand(), new WhereAmICommand(), new CheeseCommand(), new DieCommand(), new LookCommand(), new BackCommand(), new HintCommand() };
