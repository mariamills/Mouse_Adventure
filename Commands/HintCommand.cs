...
>>>You can use the 'go' command to move around the map.
>>>You can use the 'look' command to look at something you see in your current location.
...
>>>There could be secret tunnels somewhere... why not give them a 'go' by using the 'go' command?
